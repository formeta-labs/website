          ...
          <div class="p-6">
            ...
            <div class="space-y-4">
              <div class="flex items-center">
                ...
                <div class="flex-1">
                  <p class="text-sm text-gray-900">Tarea completada en Vikunja</p>
              ...
              <div class="flex items-center">
                ...
                <div class="flex-1">
                  <p class="text-sm text-gray-900">Nuevo documento procesado</p>
              ...
              <div class="flex items-center">
                ...
                <div class="flex-1">
                  <p class="text-sm text-gray-900">Automatización n8n ejecutada</p>
